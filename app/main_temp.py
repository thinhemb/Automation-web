...
#
# from start_with_computer import setStartup
...
#     file_path = os.path.join(exe_dir, 'data/Setup_Successfully.txt')
#     if os.path.isfile(file_path):
#         pass
#     else:
#         # Open the file in write mode and write some content
#         with open(file_path, 'w', encoding='utf-8') as file:
#             file.write(f'{PROJECT_NAME} Set Up Successfully!!!\n{datetime.now()}')
#         file.close()
#
...
#
#
# def is_within_runtime_range(start="07:55:00", end="19:00:00"):
#     """Check if the current time is between 8 AM and 7 PM."""
...
#             write_json(delete_unuse_folder_json, [])
#             logger.infor(f"Function delete_unuse_folder_loop is Successfully!")
#             print("Function delete_unuse_folder_loop:", time.perf_counter() - start)
#
...
#             print("check_empty_sharepoint_loop:", time.perf_counter() - start)
#
...
#             write_json(count_storage_sharepoint_json, [])
#             logger.infor(f"Function count_total_storage_sharepoint_loop is Successfully!")
#             print("count_total_storage_sharepoint_loop: ", time.perf_counter() - start)
#
...
#
#                 write_json(new_sharepoint_json, [])
#                 logger.infor(f"Function gen_folder_in_sharepoint_loop is Successfully!")
#                 print("gen_folder_in_sharepoint_loop: ", time.perf_counter() - start)
#
...
#                     time.sleep(5)
#                 task.close()
#                 write_json(permission_group_json, [])
#
#             time.sleep(30)
#
#         except Exception as e:
...
#
#             write_json(check_existed_sharepoint_json, [])
#             logger.infor(f"Function check_existed_sharepoint_loop is Successfully!")
#             print("check_existed_sharepoint_loop: ", time.perf_counter() - start)
#
...
#
#             write_json(delete_tool_sharepoint_json, [])
#             logger.infor(f"Function delete_tool_sharepoint_loop is Successfully!")
#             print("delete_tool_sharepoint_loop:", time.perf_counter() - start)
#
...
#                 task.move_data(item)
#
#             write_json(move_folder_json, [])
#             logger.infor(f"Function move_data_sharepoint_loop is Successfully!")
#             print("move_data_sharepoint_loop: ", time.perf_counter() - start)
#             # time.sleep(100)
#
...
#     state, message = setStartup(PROJECT_NAME, PROJECT_REMINDER_EXE_PATH)
#
#     mount_network_drive()
...
#     thread_9 = None
#     while True:
#         if is_within_runtime_range(start="7:45:00", end="7:55:00"):
#             thread_1 = None
#             thread_2 = None
#             thread_3 = None
#             thread_4 = None
